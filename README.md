...
- **M2**: 虚拟列表 + 预取优化 + Parser Template 预标注导入 + 数据导出 ✅
- **M3 (v1.0)**: 统计Dashboard + 完善文档 + 质量保障 ✅
- **v1.1**: 多用户协作 + JWT认证 + 图层管理 + 自定义快捷键
